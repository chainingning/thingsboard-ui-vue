    ...
    return {
      ...
      listTitle: {
        ...
        DEBUG_RULE_CHAIN: [
          ...
          { property: 'body.server', label: '服务器', width: 100 },
          { property: 'body.type', label: '类型', width: 100 },
          { property: 'body.entityName', label: '实体', width: 100 },
          { property: 'body.msgId', label: '消息ID', width: 150 },
          { property: 'body.msgType', label: '消息类型', width: 150 },
          { property: 'body.relationType', label: '关系类型', width: 100 },
          { property: 'body.data', label: '数据', width: 80 },
          { property: 'body.metadata', label: '元数据', width: 80 },
          { property: 'body.error', label: '错误', width: 150 }
        ]
      },
      title: '',
  ...
  methods: {
    ...
    async getList (params) {
      ...
      try {
        ...
        const res = await this.$api.getEvents('RULE_CHAIN', this.id, this.listQuery.eventType, {
