<template>
  <el-form ref="form" :model="form" :rules="rules">
    ...
    <el-form-item label="自定义表名" prop="tableName">
      <el-input v-model="form.tableName"></el-input>
    </el-form-item>
    <el-form-item label="字段映射" prop="fieldsMapping" class="attrMapping-container">
  ...
  data () {
    ...
    return {
      ...
      rules: {
        ...
        tableName: [{ required: true, message: '自定义表名不能为空', trigger: 'change' }],
